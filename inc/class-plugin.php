...
class Plugin
{
     ...
     */
    public function set_filesize_in_attachment_meta(array $metadata, int $attachment_id): array
    {
     ...
     * @return array
     */
    public function wp_filter_resource_hints(array $hints, string $relation_type): array
    {
        if (
